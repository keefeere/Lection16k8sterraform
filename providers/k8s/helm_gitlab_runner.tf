...
//  name       = "gitlab-runner"
//  repository = local.gitlab_helm_repository
//  chart      = "gitlab-runner"
...
////    runner_reg_token   = data.vault_generic_secret.gitlab_runner_reg_token.data["gitlab_runner_reg_token"]
//    runner_reg_token   = "sooo6a7sUkn5f41gv1cu"
